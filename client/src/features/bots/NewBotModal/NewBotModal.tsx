...
const NewBotModal = ({ open, onOpenChange, onSendBot }: NewBotModalProps) => {
  ...
  const onConfirm = async (e: any) => {
    ...
    onSendBot({
      meeting_url: (document.getElementById("meeting_url") as HTMLInputElement)
        .value,
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="DialogContent">
          ...
          <Dialog.Description className="DialogDescription">
            The bot will join the meeting at the provided URL and automatically
          ...
          <FormRoot>
            <FormField className="FormField" name="meeting_url">
              ...
              <FormMessage
                ...
                match={(value) => validateLink(value)}
              >
            ...
            <FormField className="FormField" name="name">
              ...
              <FormMessage
                className="FormMessage"
                match={(value) => validateName(value)}
              >
