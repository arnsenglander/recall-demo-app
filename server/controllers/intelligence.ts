...
export const getIntelligence: RequestHandler = async (req: Request, res: Response) => {
 ...
 */
export const createIntelligence: RequestHandler = async (req: Request, res: Response) => {
    const { botId } = req.params;
    const recallApi = new RecallApi(process.env.RECALL_API_KEY ?? '');
